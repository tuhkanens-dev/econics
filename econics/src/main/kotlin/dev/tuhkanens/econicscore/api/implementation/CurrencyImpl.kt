...
class CurrencyImpl : CurrencyAPI {
    ...
    override fun addCurrency(currencyData: CurrencyFileData): CompletableFuture<EconicsResult<Nothing>> {
    ...
    override fun removeCurrency(currencyId: String): CompletableFuture<EconicsResult<Nothing>> {
        return EconicsScheduler.supplyAsync {
            try {
    ...
    override fun getCurrency(currencyId: String): CompletableFuture<EconicsResult<CurrencyData>> {
        return EconicsScheduler.supplyAsync {
            try {
                transaction(api.getDatabase(currencyId)) {
    ...
    override fun hasCurrency(currencyId: String): CompletableFuture<EconicsResult<Nothing>> {
        return EconicsScheduler.supplyAsync {
            try {
                transaction(api.getDatabase(currencyId)) {
                    val exists = CurrenciesTable.selectAll()
