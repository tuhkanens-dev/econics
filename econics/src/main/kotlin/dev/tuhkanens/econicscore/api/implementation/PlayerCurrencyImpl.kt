...
class PlayerCurrencyImpl : PlayerCurrencyAPI {
    ...
    override fun getPlayerCurrencies(uuid: UUID, local: Boolean): CompletableFuture<EconicsResult<List<PlayerCurrencyData>>> {
    ...
    override fun addPlayerCurrency(uuid: UUID, currencyId: String, amount: BigDecimal): CompletableFuture<EconicsResult<Nothing>> {
        return EconicsScheduler.supplyAsync {
            try {
    ...
    override fun removePlayerCurrency(uuid: UUID, currencyId: String, amount: BigDecimal): CompletableFuture<EconicsResult<Nothing>> {
        return EconicsScheduler.supplyAsync {
            try {
                changePlayerCurrency(uuid, currencyId) { current ->
    ...
    override fun setPlayerCurrency(uuid: UUID, currencyId: String, amount: BigDecimal): CompletableFuture<EconicsResult<Nothing>> {
        return EconicsScheduler.supplyAsync {
            try {
    ...
    override fun getPlayerCurrency(uuid: UUID, currencyId: String): CompletableFuture<EconicsResult<BigDecimal>> {
        return EconicsScheduler.supplyAsync {
            try {
    ...
    override fun hasPlayerCurrency(uuid: UUID, currencyId: String): CompletableFuture<EconicsResult<Nothing>> {
        return EconicsScheduler.supplyAsync {
            try {
                val db = api.getDatabase(currencyId)
                transaction(db) {
